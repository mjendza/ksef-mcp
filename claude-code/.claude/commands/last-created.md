---
description: List KSeF invoices issued BY me during the previous calendar month
allowed-tools: mcp__Ksef-Mcp__ksef_authenticate, mcp__Ksef-Mcp__ksef_query_invoices, mcp__Ksef-Mcp__ksef_session_status
---

Fetch all KSeF invoices that were issued **by me** (created/sent) during the **previous calendar month**.
