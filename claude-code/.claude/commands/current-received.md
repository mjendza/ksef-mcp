---
description: List KSeF invoices received (issued TO me) during the current calendar month
allowed-tools: mcp__Ksef-Mcp__ksef_authenticate, mcp__Ksef-Mcp__ksef_query_invoices, mcp__Ksef-Mcp__ksef_session_status
---

Fetch all KSeF invoices that were issued **to me** (received) during the **current calendar month**.
